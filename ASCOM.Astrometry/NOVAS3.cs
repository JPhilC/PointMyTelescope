...
namespace ASCOM.Astrometry.NOVAS
{
   ...
   public class NOVAS3 : INOVAS3, IDisposable
   {
      ...
      public NOVAS3()
      {
         ...
         rc1 = System.Convert.ToInt16(Ephem_Open(JPLEphFile, JPL_EPHEM_START_DATE, JPL_EPHEM_END_DATE));
         if (rc1 > 0) {
      ...
      /// </example>
      /// </remarks>
      public short CioArray(double JdTdb,
         int NPts, ref
         ArrayList Cio)
      {
      ...
      /// </remarks>
      public double DLight(double[] Pos1,
         double[] PosObs)
      {
         if (Is64Bit()) {
      ...
      public double Era(double JdHigh,
         double JdLow)
      {
         if (Is64Bit()) {
      ...
      /// </pre>
      /// </remarks>
      public void FundArgs(double t, ref
         double[] a)
      {
      ...
      /// <remarks></remarks>
      public double IraEquinox(double JdTdb,
         EquinoxType Equinox,
         Accuracy Accuracy)
      {
         if (Is64Bit()) {
      ...
      /// </pre></returns>
      /// <remarks></remarks>
      public short MakeObject(ObjectType Type,
         short Number,
         string Name,
         CatEntry3 StarData, ref
         Object3 CelObj)
      {
      ...
      /// </pre></returns>
      /// <remarks></remarks>
      public short MakeObserver(ObserverLocation Where,
      ...
      public double Refract(OnSurface Location,
      ...
      public short Ter2Cel(double JdHigh, double JdLow, double DeltaT, Method Method, Accuracy Accuracy, OutputVectorOption OutputOption, double x, double y, double[] VecT, ref double[] VecC)
      {
         ...
         short rc = 0;
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(Ter2Cel64(JdHigh, JdLow, DeltaT, Method, Accuracy, OutputOption, x, y, ArrToPosVec(VecT), VVecC));
         }
         else {
            rc = System.Convert.ToInt16(Ter2Cel32(JdHigh, JdLow, DeltaT, Method, Accuracy, OutputOption, x, y, ArrToPosVec(VecT), VVecC));
         }
      ...
      private short Ephem_Open(string Ephem_Name, double
         JD_Begin,
         double JD_End)
      {
         ...
         short rc = 0;
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(EphemOpen64(Ephem_Name, JD_Begin, JD_End));
         }
         else {
            rc = System.Convert.ToInt16(EphemOpen32(Ephem_Name, JD_Begin, JD_End));
         }
         return rc;
      }
      ...
      private static short EphemOpen32(string Ephem_Name, double
      JD_Begin,
      double JD_End)
      {
      }
      ...
      [DllImport(NOVAS32DLL, EntryPoint = "wobble")] private static extern void Wobble32(double Tjd, double x, double y, ref PosVector Pos1, ref PosVector Pos2);
      #endregion
      ...
      private static short EphemOpen64(string Ephem_Name, double
      JD_Begin,
      double JD_End)
      {
      }
      ...
      [DllImport(NOVAS64DLL, EntryPoint = "wobble")] private static extern void Wobble64(double Tjd, double x, double y, ref PosVector Pos1, ref PosVector Pos2);
      #endregion
