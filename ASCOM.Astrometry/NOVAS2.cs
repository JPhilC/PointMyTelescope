...
namespace ASCOM.Astrometry.NOVAS
{
   ...
   public class NOVAS2 //Static classes cannot be exposed through COM
   {
      ...
      private struct BodyDescriptionShort
      {
         public short Type;
         public short Number;
         [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 100)] public string Name; //char[100]
      }
      ...
      {
         [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 4)] public string Catalog; //char[4]
         [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 51)] public string StarName; //char[51]
      ...
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star = CatEntryToCatEntryNOVAS2(star);
            return app_star64(tjd, ref temp_earth, ref temp_star, ref ra, ref dec);
         }
         else {
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star2 = CatEntryToCatEntryNOVAS2(star);
            return app_star32(tjd, ref temp_earth2, ref temp_star2, ref ra, ref dec);
         }
      }
      /// <summary>
      ...
      public static short TopoStar(double tjd, ref BodyDescription earth, double deltat, ref CatEntry star, ref SiteInfo location, ref double ra, ref double dec)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star = CatEntryToCatEntryNOVAS2(star);
            return topo_star64(tjd, ref temp_earth, deltat, ref temp_star, ref location, ref ra, ref dec);
         }
         else {
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star2 = CatEntryToCatEntryNOVAS2(star);
            return topo_star32(tjd, ref temp_earth2, deltat, ref temp_star2, ref location, ref ra, ref dec);
         }
      ...
      public static short AppPlanet(double tjd, ref BodyDescription ss_object, ref BodyDescription earth, ref double ra, ref double dec, ref double dis)
      {
         ...
         if (Is64Bit()) {
            BodyDescriptionShort temp_ss_object = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            return app_planet64(tjd, ref temp_ss_object, ref temp_earth, ref ra, ref dec, ref dis);
         }
         else {
            BodyDescriptionShort temp_ss_object2 = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            return app_planet32(tjd, ref temp_ss_object2, ref temp_earth2, ref ra, ref dec, ref dis);
         }
      }
      /// <summary>
      ...
      public static short TopoPlanet(double tjd, ref BodyDescription ss_object, ref BodyDescription earth, double deltat, ref SiteInfo location, ref double ra, ref double dec, ref double dis)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_ss_object = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            return topo_planet64(tjd, ref temp_ss_object, ref temp_earth, deltat, ref location, ref ra, ref dec, ref dis);
         }
         else {
            BodyDescriptionShort temp_ss_object2 = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            return topo_planet32(tjd, ref temp_ss_object2, ref temp_earth2, deltat, ref location, ref ra, ref dec, ref dis);
         }
      }
      /// <summary>
      ...
      public static short VirtualStar(double tjd, ref BodyDescription earth, ref CatEntry star, ref double ra, ref double dec)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star = CatEntryToCatEntryNOVAS2(star);
            return virtual_star64(tjd, ref temp_earth, ref temp_star, ref ra, ref dec);
         }
         else {
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star2 = CatEntryToCatEntryNOVAS2(star);
            return virtual_star32(tjd, ref temp_earth2, ref temp_star2, ref ra, ref dec);
         }
      }
      /// <summary>
      ...
      public static short LocalStar(double tjd, ref BodyDescription earth, double deltat, ref CatEntry star, ref SiteInfo location, ref double ra, ref double dec)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star = CatEntryToCatEntryNOVAS2(star);
            return local_star64(tjd, ref temp_earth, deltat, ref temp_star, ref location, ref ra, ref dec);
         }
         else {
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star2 = CatEntryToCatEntryNOVAS2(star);
            return local_star32(tjd, ref temp_earth2, deltat, ref temp_star2, ref location, ref ra, ref dec);
         }
      }
      /// <summary>
      ...
      public static short VirtualPlanet(double tjd, ref BodyDescription ss_object, ref BodyDescription earth, ref double ra, ref double dec, ref double dis)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_ss_object = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            return virtual_planet64(tjd, ref temp_ss_object, ref temp_earth, ref ra, ref dec, ref dis);
         }
         else {
            BodyDescriptionShort temp_ss_object2 = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            return virtual_planet32(tjd, ref temp_ss_object2, ref temp_earth2, ref ra, ref dec, ref dis);
         }
      }
      /// <summary>
      ...
      public static short LocalPlanet(double tjd, ref BodyDescription ss_object, ref BodyDescription earth, double deltat, ref SiteInfo location, ref double ra, ref double dec, ref double dis)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_ss_object = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            return local_planet64(tjd, ref temp_ss_object, ref temp_earth, deltat, ref location, ref ra, ref dec, ref dis);
         }
         else {
            BodyDescriptionShort temp_ss_object2 = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            return local_planet32(tjd, ref temp_ss_object2, ref temp_earth2, deltat, ref location, ref ra, ref dec, ref dis);
         }
      }
      /// <summary>
      ...
      public static short AstroStar(double tjd, ref BodyDescription earth, ref CatEntry star, ref double ra, ref double dec)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star = CatEntryToCatEntryNOVAS2(star);
            return astro_star64(tjd, ref temp_earth, ref temp_star, ref ra, ref dec);
         }
         else {
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            CatEntryNOVAS2 temp_star2 = CatEntryToCatEntryNOVAS2(star);
            return astro_star32(tjd, ref temp_earth2, ref temp_star2, ref ra, ref dec);
         }
      }
      /// <summary>
      ...
      public static short AstroPlanet(double tjd, ref BodyDescription ss_object, ref BodyDescription earth, ref double ra, ref double dec, ref double dis)
      {
         if (Is64Bit()) {
            BodyDescriptionShort temp_ss_object = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            return astro_planet64(tjd, ref temp_ss_object, ref temp_earth, ref ra, ref dec, ref dis);
         }
         else {
            BodyDescriptionShort temp_ss_object2 = BodyDescToShort(ss_object);
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            return astro_planet32(tjd, ref temp_ss_object2, ref temp_earth2, ref ra, ref dec, ref dis);
         }
      }
      /// <summary>
      ...
      {
         if (Is64Bit()) {
            equ2hor64(tjd, deltat, x, y, ref location, ra, dec, System.Convert.ToInt16(ref_option), ref zd, ref az, ref rar, ref decr);
         }
         else {
            equ2hor32(tjd, deltat, x, y, ref location, ra, dec, System.Convert.ToInt16(ref_option), ref zd, ref az, ref rar, ref decr);
         }
      }
      /// <summary>
      ...
      ///</pre></para></remarks>
      public static void TransformHip(ref CatEntry hipparcos, ref
         CatEntry fk5)
      {
         CatEntryNOVAS2 CEN2 = new CatEntryNOVAS2();

         if (Is64Bit()) {
            CatEntryNOVAS2 temp_hipparcos = CatEntryToCatEntryNOVAS2(hipparcos);
            transform_hip64(ref temp_hipparcos, ref CEN2);
         }
         else {
            CatEntryNOVAS2 temp_hipparcos2 = CatEntryToCatEntryNOVAS2(hipparcos);
            transform_hip32(ref temp_hipparcos2, ref CEN2);
         }
         CatEntryNOVAS2ToCatEntry(CEN2, fk5); //Transform to external CatEntry presentation
      }
      /// <summary>
      ...
      public static void TransformCat(TransformationOption option, double date_incat, ref CatEntry incat, double date_newcat, ref byte[] newcat_id, ref CatEntry newcat)
      {
         ...
         if (Is64Bit()) {
            CatEntryNOVAS2 temp_incat = CatEntryToCatEntryNOVAS2(incat);
            transform_cat64(System.Convert.ToInt16(option), date_incat, ref temp_incat, date_newcat, ref newcat_id, ref CEN2);
         }
         else {
            CatEntryNOVAS2 temp_incat2 = CatEntryToCatEntryNOVAS2(incat);
            transform_cat32(System.Convert.ToInt16(option), date_incat, ref temp_incat2, date_newcat, ref newcat_id, ref CEN2);
         }
         CatEntryNOVAS2ToCatEntry(CEN2, newcat); //Transform to external CatEntry presentation
      }
      /// <summary>
      ...
      {
         PosVector posv2 = new PosVector();
         if (Is64Bit()) {
            PosVector temp_pos = ArrToPosVec(pos);
            precession64(tjd1, ref temp_pos, tjd2, ref posv2);
         }
         else {
            PosVector temp_pos2 = ArrToPosVec(pos);
            precession32(tjd1, ref temp_pos2, tjd2, ref posv2);
         }
      ...
      /// </remarks>
      public static void CelPole(double del_dpsi,
         double del_deps)
      {
         if (Is64Bit()) {
      ...
      public static short Ephemeris(double tjd, ref BodyDescription cel_obj, Origin origin, ref double[] pos, ref double[] vel)
      {
         ...
         VelVector velv = new VelVector();
         short rc = 0;
         if (Is64Bit()) {
            BodyDescriptionShort temp_cel_obj = BodyDescToShort(cel_obj);
            rc = ephemeris64(tjd, ref temp_cel_obj, System.Convert.ToInt16(origin), ref posv, ref velv);
         }
         else {
            BodyDescriptionShort temp_cel_obj2 = BodyDescToShort(cel_obj);
            rc = ephemeris32(tjd, ref temp_cel_obj2, System.Convert.ToInt16(origin), ref posv, ref velv);
         }
      ...
      public static short SolarSystem(double tjd, Body body, Origin origin, ref double[] pos, ref double[] vel)
      {
         ...
         short rc = 0;
         if (Is64Bit()) {
            rc = solarsystem64(tjd, System.Convert.ToInt16(body), System.Convert.ToInt16(origin), ref posv, ref velv);
         }
         else {
            rc = solarsystem32(tjd, System.Convert.ToInt16(body), System.Convert.ToInt16(origin), ref posv, ref velv);
         }
         PosVecToArr(posv, ref pos);
         VelVecToArr(velv, ref vel);
         return rc;
      ...
      public static short Vector2RADec(double[] pos, ref double ra, ref double dec)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_pos = ArrToPosVec(pos);
            rc = vector2radec64(ref temp_pos, ref ra, ref dec);
         }
         else {
            PosVector temp_pos2 = ArrToPosVec(pos);
            rc = vector2radec32(ref temp_pos2, ref ra, ref dec);
         }
         return rc;
      }
      ...
      public static void StarVectors(CatEntry star, ref double[] pos, ref double[] vel)
      {
         ...
         if (Is64Bit()) {
            CatEntryNOVAS2 temp_star = CatEntryToCatEntryNOVAS2(star);
            starvectors64(ref temp_star, ref posv, ref velv);
         }
         else {
            CatEntryNOVAS2 temp_star2 = CatEntryToCatEntryNOVAS2(star);
            starvectors32(ref temp_star2, ref posv, ref velv);
         }
         PosVecToArr(posv, ref pos);
         VelVecToArr(velv, ref vel);
      }
      ...
      {
         short rc = 0;
         PosVector vbary_earthp = default(PosVector);
         PosVector vhelio_earthp = new PosVector();
         VelVector vbary_earthv = default(VelVector);
         VelVector vhelio_earthv = new VelVector();
         if (Is64Bit()) {
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            rc = get_earth64(tjd, ref temp_earth, ref tdb, ref vbary_earthp, ref vbary_earthv, ref vhelio_earthp, ref vhelio_earthv);
         }
         else {
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            rc = get_earth32(tjd, ref temp_earth2, ref tdb, ref vbary_earthp, ref vbary_earthv, ref vhelio_earthp, ref vhelio_earthv);
         }
      ...
      public static short MeanStar(double tjd, ref BodyDescription earth, double ra, double dec, ref double mra, ref double mdec)
      {
         ...
         if (Is64Bit()) {
            BodyDescriptionShort temp_earth = BodyDescToShort(earth);
            rc = mean_star64(tjd, ref temp_earth, ra, dec, ref mra, ref mdec);
         }
         else {
            BodyDescriptionShort temp_earth2 = BodyDescToShort(earth);
            rc = mean_star32(tjd, ref temp_earth2, ra, dec, ref mra, ref mdec);
         }
         return rc;
      }
      /// <summary>
      ...
      {
         PosVector vvecs = new PosVector();
         if (Is64Bit()) {
            PosVector temp_vece = ArrToPosVec(vece);
            pnsw64(tjd, gast, x, y, ref temp_vece, ref vvecs);
         }
         else {
            PosVector temp_vece2 = ArrToPosVec(vece);
            pnsw32(tjd, gast, x, y, ref temp_vece2, ref vvecs);
         }
      ...
      public static void Spin(double st, double[] pos1, ref double[] pos2)
      {
         ...
         if (Is64Bit()) {
            ...
            spin64(st, ref temp_pos1, ref vpos2);
         }
         else {
            PosVector temp_pos12 = ArrToPosVec(pos1);
            spin32(st, ref temp_pos12, ref vpos2);
         }
      ...
      public static void Wobble(double x, double y, double[] pos1, ref double[] pos2)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_pos1 = ArrToPosVec(pos1);
            wobble64(x, y, ref temp_pos1, ref vpos2);
         }
         else {
            PosVector temp_pos12 = ArrToPosVec(pos1);
            wobble32(x, y, ref temp_pos12, ref vpos2);
         }
         PosVecToArr(vpos2, ref pos2);
      }
      /// <summary>
      ...
      public static void ProperMotion(double tjd1, double[] pos, double[] vel, double tjd2, ref double[] pos2)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_pos = ArrToPosVec(pos);
            VelVector temp_vel = ArrToVelVec(vel);
            proper_motion64(tjd1, ref temp_pos, ref temp_vel, tjd2, ref vpos2);
         }
         else {
            PosVector temp_pos2 = ArrToPosVec(pos);
            VelVector temp_vel2 = ArrToVelVec(vel);
            proper_motion32(tjd1, ref temp_pos2, ref temp_vel2, tjd2, ref vpos2);
         }
         PosVecToArr(vpos2, ref pos2);
      }
      /// <summary>
      ...
      public static void BaryToGeo(double[] pos, double[] earthvector, ref double[] pos2, ref double lighttime)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_pos = ArrToPosVec(pos);
            PosVector temp_earthvector = ArrToPosVec(earthvector);
            bary_to_geo64(ref temp_pos, ref temp_earthvector, ref vpos2, ref lighttime);
         }
         else {
            PosVector temp_pos2 = ArrToPosVec(pos);
            PosVector temp_earthvector2 = ArrToPosVec(earthvector);
            bary_to_geo32(ref temp_pos2, ref temp_earthvector2, ref vpos2, ref lighttime);
         }
         PosVecToArr(vpos2, ref pos2);
      }
      /// <summary>
      ...
      public static short SunField(double[] pos, double[] earthvector, ref double[] pos2)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_pos = ArrToPosVec(pos);
            PosVector temp_earthvector = ArrToPosVec(earthvector);
            rc = sun_field64(ref temp_pos, ref temp_earthvector, ref vpos2);
         }
         else {
            PosVector temp_pos2 = ArrToPosVec(pos);
            PosVector temp_earthvector2 = ArrToPosVec(earthvector);
            rc = sun_field32(ref temp_pos2, ref temp_earthvector2, ref vpos2);
         }
         PosVecToArr(vpos2, ref pos2);
         return rc;
      }
      ...
      public static short Aberration(double[] pos, double[] vel, double lighttime, ref double[] pos2)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_pos = ArrToPosVec(pos);
            VelVector temp_vel = ArrToVelVec(vel);
            rc = aberration64(ref temp_pos, ref temp_vel, lighttime, ref vpos2);
         }
         else {
            PosVector temp_pos2 = ArrToPosVec(pos);
            VelVector temp_vel2 = ArrToVelVec(vel);
            rc = aberration32(ref temp_pos2, ref temp_vel2, lighttime, ref vpos2);
         }
         PosVecToArr(vpos2, ref pos2);
         return rc;
      }
      ...
      public static short Nutate(double tjd, NutationDirection fn, double[] pos, ref double[] pos2)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_pos = ArrToPosVec(pos);
            rc = nutate64(tjd, System.Convert.ToInt16(fn), ref temp_pos, ref vpos2);
         }
         else {
            PosVector temp_pos2 = ArrToPosVec(pos);
            rc = nutate32(tjd, System.Convert.ToInt16(fn), ref temp_pos2, ref vpos2);
         }
         PosVecToArr(vpos2, ref pos2);
         return rc;
      }
      ...
      /// <remarks></remarks>
      public static void FundArgs(double t, ref
         double[] a)
      {
      ...
      ///</pre></returns>
      /// <remarks></remarks>
      public static short SetBody(BodyType type, Body number, string name, BodyDescription cel_obj)
      {
         BodyDescriptionShort BDS = new BodyDescriptionShort();
         if (Is64Bit()) {
            return set_body64(System.Convert.ToInt16(type), System.Convert.ToInt16(number), name, ref BDS);
         }
         else {
            return set_body32(System.Convert.ToInt16(type), System.Convert.ToInt16(number), name, ref BDS);
         }
      ...
      public static void MakeCatEntry(string catalog, string star_name, int star_num, double ra, double dec, double pm_ra, double pm_dec, double parallax, double rad_vel, ref CatEntry star)
      {
         ...
         CatEntryNOVAS2ToCatEntry(CEN2, star); //Convert to external presentation
      ...
      public static double Refract(ref SiteInfo location,
         short ref_option,
         double zd_obs)
      {
         if (Is64Bit()) {
      ...
      {
         return ASCOM.Astrometry.DeltatCode.DeltaTCalc(Tjd);
      }
      #endregion

      #region DLL Entry Points (32bit)
      [DllImport(NOVAS32Dll, EntryPoint = "app_star")] private static extern short app_star32(double tjd, ref BodyDescriptionShort earth, ref CatEntryNOVAS2 star, ref double ra, ref double dec);
      [DllImport(NOVAS32Dll, EntryPoint = "topo_star")] private static extern short topo_star32(double tjd, ref BodyDescriptionShort earth, double deltat, ref CatEntryNOVAS2 star, ref SiteInfo location, ref double ra, ref double dec);
      [DllImport(NOVAS32Dll, EntryPoint = "app_planet")] private static extern short app_planet32(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, ref double ra, ref double dec, ref double dis);

      [DllImport(NOVAS32Dll, EntryPoint = "topo_planet")] private static extern short topo_planet32(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, double deltat, ref SiteInfo location, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS32Dll, EntryPoint = "virtual_star")] private static extern short virtual_star32(double tjd, ref BodyDescriptionShort earth, ref CatEntryNOVAS2 star, ref double ra, ref double dec);
      [DllImport(NOVAS32Dll, EntryPoint = "local_star")] private static extern short local_star32(double tjd, ref BodyDescriptionShort earth, double deltat, ref CatEntryNOVAS2 star, ref SiteInfo location, ref double ra, ref double dec);
      [DllImport(NOVAS32Dll, EntryPoint = "virtual_planet")] private static extern short virtual_planet32(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS32Dll, EntryPoint = "local_planet")] private static extern short local_planet32(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, double deltat, ref SiteInfo location, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS32Dll, EntryPoint = "astro_star")] private static extern short astro_star32(double tjd, ref BodyDescriptionShort earth, ref CatEntryNOVAS2 star, ref double ra, ref double dec);
      [DllImport(NOVAS32Dll, EntryPoint = "astro_planet")] private static extern short astro_planet32(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS32Dll, EntryPoint = "equ2hor")] private static extern void equ2hor32(double tjd, double deltat, double x, double y, ref SiteInfo location, double ra, double dec, short ref_option, ref double zd, ref double az, ref double rar, ref double decr);
      [DllImport(NOVAS32Dll, EntryPoint = "transform_hip")]
      private static extern void transform_hip32(ref CatEntryNOVAS2 hipparcos, ref
      CatEntryNOVAS2 fk5);
      [DllImport(NOVAS32Dll, EntryPoint = "transform_cat")] private static extern void transform_cat32(short option, double date_incat, ref CatEntryNOVAS2 incat, double date_newcat, ref byte[] newcat_id, ref CatEntryNOVAS2 newcat);
      [DllImport(NOVAS32Dll, EntryPoint = "sidereal_time")] private static extern void sidereal_time32(double jd_high, double jd_low, double ee, ref double gst);
      [DllImport(NOVAS32Dll, EntryPoint = "precession")] private static extern void precession32(double tjd1, ref PosVector pos, double tjd2, ref PosVector pos2);
      [DllImport(NOVAS32Dll, EntryPoint = "earthtilt")] private static extern void earthtilt32(double tjd, ref double mobl, ref double tobl, ref double eq, ref double dpsi, ref double deps);
      [DllImport(NOVAS32Dll, EntryPoint = "cel_pole")]
      private static extern void cel_pole32(double del_dpsi,
      double del_deps);
      [DllImport(NOVAS32Dll, EntryPoint = "ephemeris")]
      private static extern short ephemeris32(double tjd, ref
      BodyDescriptionShort cel_obj,
      short origin, ref
      PosVector pos, ref
      VelVector vel);
      ...
      private static extern void starvectors32(ref CatEntryNOVAS2 star, ref
      PosVector pos, ref
      VelVector vel);

      [DllImport(NOVAS32Dll, EntryPoint = "radec2vector")] private static extern void radec2vector32(double ra, double dec, double dist, ref PosVector pos);
      [DllImport(NOVAS32Dll, EntryPoint = "get_earth")] private static extern short get_earth32(double tjd, ref BodyDescriptionShort earth, ref double tdb, ref PosVector bary_earthp, ref VelVector bary_earthv, ref PosVector helio_earthp, ref VelVector helio_earthv);
      //
      //START OF NEW
      //
      [DllImport(NOVAS32Dll, EntryPoint = "mean_star")] private static extern short mean_star32(double tjd, ref BodyDescriptionShort earth, double ra, double dec, ref double mra, ref double mdec);
      [DllImport(NOVAS32Dll, EntryPoint = "pnsw")] private static extern void pnsw32(double tjd, double gast, double x, double y, ref PosVector vece, ref PosVector vecs);
      [DllImport(NOVAS32Dll, EntryPoint = "spin")]
      private static extern void spin32(double st, ref PosVector
      pos1, ref
      PosVector pos2);

      [DllImport(NOVAS32Dll, EntryPoint = "wobble")] private static extern void wobble32(double x, double y, ref PosVector pos1, ref PosVector pos2);
      [DllImport(NOVAS32Dll, EntryPoint = "terra")]
      private static extern void terra32(ref SiteInfo locale,
      double st, ref
      PosVector pos, ref
      VelVector vel);

      [DllImport(NOVAS32Dll, EntryPoint = "proper_motion")] private static extern void proper_motion32(double tjd1, ref PosVector pos, ref VelVector vel, double tjd2, ref PosVector pos2);
      [DllImport(NOVAS32Dll, EntryPoint = "bary_to_geo")] private static extern void bary_to_geo32(ref PosVector pos, ref PosVector earthvector, ref PosVector pos2, ref double lighttime);
      [DllImport(NOVAS32Dll, EntryPoint = "sun_field")] private static extern short sun_field32(ref PosVector pos, ref PosVector earthvector, ref PosVector pos2);


      [DllImport(NOVAS32Dll, EntryPoint = "aberration")] private static extern short aberration32(ref PosVector pos, ref VelVector vel, double lighttime, ref PosVector pos2);

      [DllImport(NOVAS32Dll, EntryPoint = "nutate")]
      private static extern short nutate32(double tjd,
      short fn, ref PosVector
      pos, ref
      PosVector pos2);

      [DllImport(NOVAS32Dll, EntryPoint = "nutation_angles")] private static extern short nutation_angles32(double tdbtime, ref double longnutation, ref double obliqnutation);


      [DllImport(NOVAS32Dll, EntryPoint = "fund_args")]
      private static extern void fund_args32(double t, ref
      FundamentalArgs a);
      [DllImport(NOVAS32Dll, EntryPoint = "tdb2tdt")] private static extern void tdb2tdt32(double tdb, ref double tdtjd, ref double secdiff);

      [DllImport(NOVAS32Dll, EntryPoint = "set_body")] private static extern short set_body32(short type, short number, string name, ref BodyDescriptionShort cel_obj);

      [DllImport(NOVAS32Dll, EntryPoint = "readeph")] private static extern PosVector readeph32(int mp, System.IntPtr name, double jd, ref int err);

      [DllImport(NOVAS32Dll, EntryPoint = "make_cat_entry")] private static extern void make_cat_entry32(string catalog, string star_name, int star_num, double ra, double dec, double pm_ra, double pm_dec, double parallax, double rad_vel, ref CatEntryNOVAS2 star);

      [DllImport(NOVAS32Dll, EntryPoint = "refract")]
      private static extern double refract32(ref SiteInfo location,
      short ref_option,
      double zd_obs);

      [DllImport(NOVAS32Dll, EntryPoint = "julian_date")] private static extern double julian_date32(short year, short month, short day, double hour);

      [DllImport(NOVAS32Dll, EntryPoint = "cal_date")] private static extern void cal_date32(double tjd, ref short year, ref short month, ref short day, ref double hour);
      [DllImport(NOVAS32Dll, EntryPoint = "sun_eph")] private static extern void sun_eph32(double jd, ref double ra, ref double dec, ref double dis);
      ...
      [DllImport(NOVAS64Dll, EntryPoint = "app_star")] private static extern short app_star64(double tjd, ref BodyDescriptionShort earth, ref CatEntryNOVAS2 star, ref double ra, ref double dec);
      [DllImport(NOVAS64Dll, EntryPoint = "topo_star")] private static extern short topo_star64(double tjd, ref BodyDescriptionShort earth, double deltat, ref CatEntryNOVAS2 star, ref SiteInfo location, ref double ra, ref double dec);
      [DllImport(NOVAS64Dll, EntryPoint = "app_planet")] private static extern short app_planet64(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS64Dll, EntryPoint = "topo_planet")] private static extern short topo_planet64(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, double deltat, ref SiteInfo location, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS64Dll, EntryPoint = "virtual_star")] private static extern short virtual_star64(double tjd, ref BodyDescriptionShort earth, ref CatEntryNOVAS2 star, ref double ra, ref double dec);
      [DllImport(NOVAS64Dll, EntryPoint = "local_star")] private static extern short local_star64(double tjd, ref BodyDescriptionShort earth, double deltat, ref CatEntryNOVAS2 star, ref SiteInfo location, ref double ra, ref double dec);
      [DllImport(NOVAS64Dll, EntryPoint = "virtual_planet")] private static extern short virtual_planet64(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS64Dll, EntryPoint = "local_planet")] private static extern short local_planet64(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, double deltat, ref SiteInfo location, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS64Dll, EntryPoint = "astro_star")] private static extern short astro_star64(double tjd, ref BodyDescriptionShort earth, ref CatEntryNOVAS2 star, ref double ra, ref double dec);
      [DllImport(NOVAS64Dll, EntryPoint = "astro_planet")] private static extern short astro_planet64(double tjd, ref BodyDescriptionShort ss_object, ref BodyDescriptionShort earth, ref double ra, ref double dec, ref double dis);
      [DllImport(NOVAS64Dll, EntryPoint = "equ2hor")] private static extern void equ2hor64(double tjd, double deltat, double x, double y, ref SiteInfo location, double ra, double dec, short ref_option, ref double zd, ref double az, ref double rar, ref double decr);
      [DllImport(NOVAS64Dll, EntryPoint = "transform_hip")]
      private static extern void transform_hip64(ref CatEntryNOVAS2 hipparcos, ref
      CatEntryNOVAS2 fk5);
      [DllImport(NOVAS64Dll, EntryPoint = "transform_cat")] private static extern void transform_cat64(short option, double date_incat, ref CatEntryNOVAS2 incat, double date_newcat, ref byte[] newcat_id, ref CatEntryNOVAS2 newcat);
      [DllImport(NOVAS64Dll, EntryPoint = "sidereal_time")] private static extern void sidereal_time64(double jd_high, double jd_low, double ee, ref double gst);
      [DllImport(NOVAS64Dll, EntryPoint = "precession")] private static extern void precession64(double tjd1, ref PosVector pos, double tjd2, ref PosVector pos2);
      [DllImport(NOVAS64Dll, EntryPoint = "earthtilt")] private static extern void earthtilt64(double tjd, ref double mobl, ref double tobl, ref double eq, ref double dpsi, ref double deps);
      [DllImport(NOVAS64Dll, EntryPoint = "cel_pole")]
      private static extern void cel_pole64(double del_dpsi,
      double del_deps);
      [DllImport(NOVAS64Dll, EntryPoint = "ephemeris")]
      private static extern short ephemeris64(double tjd, ref
      BodyDescriptionShort cel_obj,
      short origin, ref
      PosVector pos, ref
      VelVector vel);
      ...
      private static extern void starvectors64(ref CatEntryNOVAS2 star, ref
      PosVector pos, ref
      VelVector vel);
      [DllImport(NOVAS64Dll, EntryPoint = "radec2vector")] private static extern void radec2vector64(double ra, double dec, double dist, ref PosVector pos);
      [DllImport(NOVAS64Dll, EntryPoint = "get_earth")] private static extern short get_earth64(double tjd, ref BodyDescriptionShort earth, ref double tdb, ref PosVector bary_earthp, ref VelVector bary_earthv, ref PosVector helio_earthp, ref VelVector helio_earthv);
      //
      //START OF NEW
      //
      [DllImport(NOVAS64Dll, EntryPoint = "mean_star")] private static extern short mean_star64(double tjd, ref BodyDescriptionShort earth, double ra, double dec, ref double mra, ref double mdec);
      [DllImport(NOVAS64Dll, EntryPoint = "pnsw")] private static extern void pnsw64(double tjd, double gast, double x, double y, ref PosVector vece, ref PosVector vecs);
      [DllImport(NOVAS64Dll, EntryPoint = "spin")]
      private static extern void spin64(double st, ref PosVector
      pos1, ref
      PosVector pos2);

      [DllImport(NOVAS64Dll, EntryPoint = "wobble")] private static extern void wobble64(double x, double y, ref PosVector pos1, ref PosVector pos2);
      [DllImport(NOVAS64Dll, EntryPoint = "terra")]
      private static extern void terra64(ref SiteInfo locale,
      double st, ref
      PosVector pos, ref
      VelVector vel);

      [DllImport(NOVAS64Dll, EntryPoint = "proper_motion")] private static extern void proper_motion64(double tjd1, ref PosVector pos, ref VelVector vel, double tjd2, ref PosVector pos2);
      [DllImport(NOVAS64Dll, EntryPoint = "bary_to_geo")] private static extern void bary_to_geo64(ref PosVector pos, ref PosVector earthvector, ref PosVector pos2, ref double lighttime);
      [DllImport(NOVAS64Dll, EntryPoint = "sun_field")] private static extern short sun_field64(ref PosVector pos, ref PosVector earthvector, ref PosVector pos2);


      [DllImport(NOVAS64Dll, EntryPoint = "aberration")] private static extern short aberration64(ref PosVector pos, ref VelVector vel, double lighttime, ref PosVector pos2);

      [DllImport(NOVAS64Dll, EntryPoint = "nutate")]
      private static extern short nutate64(double tjd,
      short fn, ref PosVector
      pos, ref
      PosVector pos2);

      [DllImport(NOVAS64Dll, EntryPoint = "nutation_angles")] private static extern short nutation_angles64(double tdbtime, ref double longnutation, ref double obliqnutation);

      [DllImport(NOVAS64Dll, EntryPoint = "fund_args")]
      private static extern void fund_args64(double t, ref
      FundamentalArgs a);
      [DllImport(NOVAS64Dll, EntryPoint = "tdb2tdt")] private static extern void tdb2tdt64(double tdb, ref double tdtjd, ref double secdiff);

      [DllImport(NOVAS64Dll, EntryPoint = "set_body")] private static extern short set_body64(short type, short number, string name, ref BodyDescriptionShort cel_obj);

      [DllImport(NOVAS64Dll, EntryPoint = "readeph")] private static extern PosVector readeph64(int mp, System.IntPtr name, double jd, ref int err);

      [DllImport(NOVAS64Dll, EntryPoint = "make_cat_entry")] private static extern void make_cat_entry64(string catalog, string star_name, int star_num, double ra, double dec, double pm_ra, double pm_dec, double parallax, double rad_vel, ref CatEntryNOVAS2 star);

      [DllImport(NOVAS64Dll, EntryPoint = "refract")]
      private static extern double refract64(ref SiteInfo location,
      short ref_option,
      double zd_obs);

      [DllImport(NOVAS64Dll, EntryPoint = "julian_date")] private static extern double julian_date64(short year, short month, short day, double hour);

      [DllImport(NOVAS64Dll, EntryPoint = "cal_date")] private static extern void cal_date64(double tjd, ref short year, ref short month, ref short day, ref double hour);
      [DllImport(NOVAS64Dll, EntryPoint = "sun_eph")] private static extern void sun_eph64(double jd, ref double ra, ref double dec, ref double dis);

      [DllImport(NOVAS64Dll, EntryPoint = "solarsystem")]
      private static extern short solarsystem64(double tjd,
      short body, ref
      int origin, ref
      PosVector pos, ref
      VelVector vel);
      ...
      static public extern bool SHGetSpecialFolderPath(IntPtr hwndOwner, System.Text.StringBuilder lpszPath,
      int nFolder,
      bool fCreate);

      //Declare the api call that sets the additional DLL search directory
      [DllImport("kernel32.dll", SetLastError = false)] private static extern bool SetDllDirectory(string lpPathName);

      // VBConversions Note: Former VB static variables moved to class level because they aren't supported in C#.
      static string Is64Bit_StatPath = "";

      private static bool Is64Bit()
      {
         bool rc;
         // static string StatPath = ""; VBConversions Note: Static variable moved to class level and renamed Is64Bit_StatPath. Local static variables are not supported in C#.
         ...
         if (string.IsNullOrEmpty(Is64Bit_StatPath)) {
            ...
            if (IntPtr.Size == 8) // 64bit application so find the 32bit folder location
            {
               ...
               CommonProgramFilesPath = System.Convert.ToString(ReturnedPath.ToString());
            }
            else //32bit application so just go with the .NET returned value
            {
               CommonProgramFilesPath = System.Convert.ToString(System.Environment.GetFolderPath(Environment.SpecialFolder.CommonProgramFiles));
            }

            Is64Bit_StatPath = CommonProgramFilesPath + NOVAS_DLL_LOCATION;
            //Add the ASCOM\.net directory to the DLL search path so that the NOVAS C 32 and 64bit DLLs can be found
            rc = SetDllDirectory(Is64Bit_StatPath);
         }
      ...
      private static BodyDescriptionShort BodyDescToShort(BodyDescription BD)
      {
         ...
         BodyDescriptionShort BDS = new BodyDescriptionShort();
         BDS.Name = System.Convert.ToString(BD.Name);
         BDS.Number = System.Convert.ToInt16(BD.Number);
         BDS.Type = System.Convert.ToInt16(BD.Type);
         return BDS;
      }
      ...
      private static CatEntryNOVAS2 CatEntryToCatEntryNOVAS2(CatEntry CE)
      {
         ...
         //This ensures that the C functions run OK (using shorts) while the public face is integer.
         CatEntryNOVAS2 CEN2 = new CatEntryNOVAS2();
         CEN2.Catalog = System.Convert.ToString(CE.Catalog);
         CEN2.Dec = System.Convert.ToDouble(CE.Dec);
         CEN2.Parallax = System.Convert.ToDouble(CE.Parallax);
         CEN2.ProMoDec = System.Convert.ToDouble(CE.ProMoDec);
         CEN2.ProMoRA = System.Convert.ToDouble(CE.ProMoRA);
         CEN2.RA = System.Convert.ToDouble(CE.RA);
         CEN2.RadialVelocity = System.Convert.ToDouble(CE.RadialVelocity);
         CEN2.StarName = System.Convert.ToString(CE.StarName);
         CEN2.StarNumber = System.Convert.ToInt32(CE.StarNumber);
         return CEN2;
      }

      private static void CatEntryNOVAS2ToCatEntry(CatEntryNOVAS2 CEN2, CatEntry CE)
      {
