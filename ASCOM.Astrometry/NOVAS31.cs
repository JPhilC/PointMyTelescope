...
namespace ASCOM.Astrometry.NOVAS
{
   ...
   public class NOVAS31 : INOVAS31, IDisposable
   {
      ...
      private const double JPL_EPHEM_START_DATE = 2305424.5; //First date of data in the ephemeredes file
      private const double JPL_EPHEM_END_DATE = 2525008.5; //Last date of data in the ephemeredes file
      ...
      public NOVAS31()
      {
         ...
         try {
            ...
            {
               rc = System.Convert.ToBoolean(SHGetSpecialFolderPath(IntPtr.Zero, ReturnedPath, CSIDL_PROGRAM_FILES_COMMONX86, false));
            ...
            rc1 = System.Convert.ToInt16(Ephem_Open(JPLEphFile, JPL_EPHEM_START_DATE, JPL_EPHEM_END_DATE, DENumber));
         }
         finally {
            Novas31Mutex.ReleaseMutex(); // Release the initialisation mutex
         }
         if (rc1 > 0) {
            TL.LogMessage("New", "Unable to open ephemeris file: " + JPLEphFile + ", RC: " + System.Convert.ToString(rc1));
            throw (new HelperException("Unable to open ephemeris file: " + JPLEphFile + ", RC: " + System.Convert.ToString(rc1)));
         }
      ...
      public short PlanetEphemeris(ref double[] Tjd, Target Target, Target Center, ref double[] Position, ref double[] Velocity)
      {
         ...
         JDHighPrecision JdHp = new JDHighPrecision();
         PosVector VPos = new PosVector();
         VelVector VVel = new VelVector();
         short rc = 0;

         JdHp.JDPart1 = Tjd[0];
         JdHp.JDPart2 = Tjd[1];
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(PlanetEphemeris64(JdHp, Target, Center, VPos, VVel));
         }
         else {
            rc = System.Convert.ToInt16(PlanetEphemeris32(JdHp, Target, Center, VPos, VVel));
         }
      ...
      public double[] ReadEph(int Mp, string Name, double Jd, ref int Err)
      {
         ...
         double[] PosVec = new double[NUM_RETURN_VALUES - 1 + 1];
         IntPtr EphPtr = default(IntPtr);
         byte[] Bytes = new byte[NUM_RETURN_VALUES * DOUBLE_LENGTH + 1];
         ...
         if (Err == 0) // Get the returned values if the call was successful
         {
            if (EphPtr != IntPtr.Zero) //Only copy if the pointer is not NULL
            {
               ...
               for (int i = 0; i <= NUM_RETURN_VALUES - 1; i++) {
                  PosVec[i] = System.Convert.ToDouble(BitConverter.ToDouble(Bytes, i * DOUBLE_LENGTH));
               }
            }
            else {
               for (int i = 0; i <= NUM_RETURN_VALUES - 1; i++) {
                  PosVec[i] = System.Convert.ToDouble(double.NaN); //Return invalid values
               }
            }
         }
         return PosVec;
      ...
      public short SolarSystem(double Tjd, Body Body, Origin Origin, ref double[] Pos, ref double[] Vel)
      {
         ...
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(SolarSystem64(Tjd, System.Convert.ToInt16(Body), System.Convert.ToInt16(Origin), VPos, VVel));
         }
         else {
            rc = System.Convert.ToInt16(SolarSystem32(Tjd, System.Convert.ToInt16(Body), System.Convert.ToInt16(Origin), VPos, VVel));
         }
      ...
      public short State(ref double[] Jed, Target Target, ref double[] TargetPos, ref double[] TargetVel)
      {
         ...
         JdHp.JDPart2 = Jed[1];
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(State64(JdHp, Target, VPos, VVel));
         }
         else {
            rc = System.Convert.ToInt16(State32(JdHp, Target, VPos, VVel));
         }
      ...
      {
         PosVector VPos2 = default(PosVector);
         if (Is64Bit()) {
      ...
      public short AppStar(double JdTt, CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec)
      {
         ...
         short rc = 0;
         try {
            TL.LogMessage("AppStar", "JD Accuracy:        " + System.Convert.ToString(JdTt) + " " + Accuracy.ToString());
         ...
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(AppStar64(JdTt, Star, Accuracy, Ra, Dec));
            TL.LogMessage("AppStar", "  64bit - Return Code: " + System.Convert.ToString(rc) + ", RA Dec: " + Utl.HoursToHMS(Ra, ":", ":", "", 3) + " " + Utl.DegreesToDMS(Dec, ":", ":", "", 3));
            return rc;
         }
         else {
            rc = System.Convert.ToInt16(AppStar32(JdTt, Star, Accuracy, Ra, Dec));
            TL.LogMessage("AppStar", "  32bit - Return Code: " + System.Convert.ToString(rc) + ", RA Dec: " + Utl.HoursToHMS(Ra, ":", ":", "", 3) + " " + Utl.DegreesToDMS(Dec, ":", ":", "", 3));
            return rc;
         }
      ...
      public short AstroStar(double JdTt, CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec)
      {
         short rc = 0;
         try {
            TL.LogMessage("AstroStar", "JD Accuracy:        " + System.Convert.ToString(JdTt) + " " + Accuracy.ToString());
         ...
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(AstroStar64(JdTt, Star, Accuracy, Ra, Dec));
            TL.LogMessage("AstroStar", "  64bit - Return Code: " + System.Convert.ToString(rc) + ", RA Dec: " + Utl.HoursToHMS(Ra, ":", ":", "", 3) + " " + Utl.DegreesToDMS(Dec, ":", ":", "", 3));
            return rc;
         }
         else {
            rc = System.Convert.ToInt16(AstroStar32(JdTt, Star, Accuracy, Ra, Dec));
            TL.LogMessage("AstroStar", "  32bit - Return Code: " + System.Convert.ToString(rc) + ", RA Dec: " + Utl.HoursToHMS(Ra, ":", ":", "", 3) + " " + Utl.DegreesToDMS(Dec, ":", ":", "", 3));
            return rc;
         }
      }
      ...
      {
         PosVector VVecC = new PosVector();
         short rc = 0;
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(Cel2Ter64(JdHigh, JdLow, DeltaT, Method, Accuracy, OutputOption, xp, yp, ArrToPosVec(VecT), VVecC));
         }
         else {
            rc = System.Convert.ToInt16(Cel2Ter32(JdHigh, JdLow, DeltaT, Method, Accuracy, OutputOption, xp, yp, ArrToPosVec(VecT), VVecC));
         }
      ...
      {
         RAOfCioArray CioStruct = new RAOfCioArray();
         short rc = 0;

         CioStruct.Initialise(); //Set internal default values so we can see which elements are changed by the NOVAS DLL.
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(CioArray64(JdTdb, NPts, CioStruct));
         }
         else {
            rc = System.Convert.ToInt16(CioArray32(JdTdb, NPts, CioStruct));
         }
      ...
      {
         PosVector VPos2 = new PosVector();
         short rc = 0;
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(Ecl2EquVec64(JdTt, CoordSys, Accuracy, ArrToPosVec(Pos1), VPos2));
         }
         else {
            rc = System.Convert.ToInt16(Ecl2EquVec32(JdTt, CoordSys, Accuracy, ArrToPosVec(Pos1), VPos2));
         }
      ...
      public short Ephemeris(double[] Jd, Object3 CelObj, Origin Origin, Accuracy Accuracy, ref double[] Pos, ref double[] Vel)
      {
         PosVector VPos = new PosVector();
         VelVector VVel = new VelVector();
         JDHighPrecision JdHp = default(JDHighPrecision);
         short rc = 0;
         JdHp.JDPart1 = Jd[0];
         JdHp.JDPart2 = Jd[1];
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(Ephemeris64(JdHp, O3IFromObject3(CelObj), Origin, Accuracy, VPos, VVel));
         }
         else {
            rc = System.Convert.ToInt16(Ephemeris32(JdHp, O3IFromObject3(CelObj), Origin, Accuracy, VPos, VVel));
         }
      ...
      public short Equ2EclVec(double JdTt, CoordSys CoordSys, Accuracy Accuracy, double[] Pos1, ref double[] Pos2)
      {
         ...
         short rc = 0;
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(Equ2EclVec64(JdTt, CoordSys, Accuracy, ArrToPosVec(Pos1), VPos2));
         }
         else {
            rc = System.Convert.ToInt16(Equ2EclVec32(JdTt, CoordSys, Accuracy, ArrToPosVec(Pos1), VPos2));
         }
      ...
      public void Equ2Hor(double Jd_Ut1, double DeltT, Accuracy Accuracy, double xp, double yp, OnSurface Location, double Ra, double Dec, RefractionOption RefOption, ref double Zd, ref double Az, ref double RaR, ref double DecR)
      {
         try {
            ...
            TL.LogMessage("Equ2Hor", "JD Accuracy RA DEC:     " + System.Convert.ToString(Jd_Ut1) + " " + Accuracy.ToString() + " " + Utl.HoursToHMS(Ra, ":", ":", "", 3) + " " + Utl.DegreesToDMS(Dec, ":", ":", "", 3));
            TL.LogMessage("Equ2Hor", "  DeltaT:               " + System.Convert.ToString(DeltT));
            TL.LogMessage("Equ2Hor", "  xp:                   " + System.Convert.ToString(xp));
            TL.LogMessage("Equ2Hor", "  yp:                   " + System.Convert.ToString(yp));
      ...
      {
         FundamentalArgs va = new FundamentalArgs();
         ...
         a[0] = System.Convert.ToDouble(va.l);
         a[1] = System.Convert.ToDouble(va.ldash);
         a[2] = System.Convert.ToDouble(va.F);
         a[3] = System.Convert.ToDouble(va.D);
         a[4] = System.Convert.ToDouble(va.Omega);
      ...
      public short GeoPosVel(double JdTt, double DeltaT, Accuracy Accuracy, Observer Obs, ref double[] Pos, ref double[] Vel)
      {
         ...
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(GeoPosVel64(JdTt, DeltaT, Accuracy, Obs, VPos, VVel));
         }
         else {
            rc = System.Convert.ToInt16(GeoPosVel32(JdTt, DeltaT, Accuracy, Obs, VPos, VVel));
         }
      ...
      public short GravDef(double JdTdb, EarthDeflection LocCode, Accuracy Accuracy, double[] Pos1, double[] PosObs, ref double[] Pos2)
      {
         ...
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(GravDef64(JdTdb, LocCode, Accuracy, ArrToPosVec(Pos1), ArrToPosVec(PosObs), VPos2));
         }
         else {
            rc = System.Convert.ToInt16(GravDef32(JdTdb, LocCode, Accuracy, ArrToPosVec(Pos1), ArrToPosVec(PosObs), VPos2));
         }
      ...
      public short LightTime(double JdTdb, Object3 SsObject, double[] PosObs, double TLight0, Accuracy Accuracy, ref double[] Pos, ref double TLight)
      {
         ...
         short rc = 0;
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(LightTime64(JdTdb, O3IFromObject3(SsObject), ArrToPosVec(PosObs), TLight0, Accuracy, VPos, TLight));
         }
         else {
            rc = System.Convert.ToInt16(LightTime32(JdTdb, O3IFromObject3(SsObject), ArrToPosVec(PosObs), TLight0, Accuracy, VPos, TLight));
         }
      ...
      {
         Object3Internal O3I = new Object3Internal();
         short rc = 0;

         if (Is64Bit()) {
            rc = System.Convert.ToInt16(MakeObject64(Type, Number, Name, StarData, O3I));
         }
         else {
            rc = System.Convert.ToInt16(MakeObject32(Type, Number, Name, StarData, O3I));
         }
      ...
      public short Precession(double JdTdb1, double[] Pos1, double JdTdb2, ref double[] Pos2)
      {
         ...
         if (Is64Bit()) {
            rc = System.Convert.ToInt16(Precession64(JdTdb1, ArrToPosVec(Pos1), JdTdb2, VPos2));
         }
         else {
            rc = System.Convert.ToInt16(Precession32(JdTdb1, ArrToPosVec(Pos1), JdTdb2, VPos2));
         }
         PosVecToArr(VPos2, Pos2);
         return rc;
      }
      ...
      {
         PosVector VVector = new PosVector();
      ...
      public void Spin(double Angle, double[] Pos1, ref double[] Pos2)
      {
         PosVector VPOs2 = new PosVector();
         if (Is64Bit()) {
            PosVector temp_Pos1 = ArrToPosVec(Pos1);
            Spin64(Angle, ref temp_Pos1, ref VPOs2);
         }
         else {
            PosVector temp_Pos12 = ArrToPosVec(Pos1);
            Spin32(Angle, ref temp_Pos12, ref VPOs2);
         }
      ...
      /// <remarks></remarks>
      public void StarVectors(CatEntry3 Star, ref double[]
         Pos, ref
         double[] Vel)
      {
         PosVector VPos = new PosVector();
      ...
      public short Ter2Cel(double JdHigh, double JdLow, double DeltaT, Method Method, Accuracy Accuracy, OutputVectorOption OutputOption, double xp, double yp, double[] VecT, ref double[] VecC)
      {
         ...
         short rc = 0;
         if (Is64Bit()) {
            PosVector temp_VecT = ArrToPosVec(VecT);
            rc = Ter2Cel64(JdHigh, JdLow, DeltaT, Method, Accuracy, OutputOption, xp, yp, ref temp_VecT, ref VVecC);
         }
         else {
            PosVector temp_VecT2 = ArrToPosVec(VecT);
            rc = Ter2Cel32(JdHigh, JdLow, DeltaT, Method, Accuracy, OutputOption, xp, yp, ref temp_VecT2, ref VVecC);
         }
      ...
      {
         if (Is64Bit()) {
            Object3Internal temp_SsBody = O3IFromObject3(SsBody);
            return TopoPlanet64(JdTt, ref temp_SsBody, DeltaT, ref Position, Accuracy, ref Ra, ref Dec, ref Dis);
         }
         else {
            Object3Internal temp_SsBody2 = O3IFromObject3(SsBody);
            return TopoPlanet32(JdTt, ref temp_SsBody2, DeltaT, ref Position, Accuracy, ref Ra, ref Dec, ref Dis);
         }
      }
      ...
      public short TopoStar(double JdTt, double DeltaT, CatEntry3 Star, OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec)
      {
         ...
         short rc = 0;
         try {
            TL.LogMessage("TopoStar", "JD Accuracy:            " + System.Convert.ToString(JdTt) + " " + Accuracy.ToString());
            ...
            if (Is64Bit()) {
               ...
               TL.LogMessage("TopoStar", "  64bit - Return Code: " + System.Convert.ToString(rc) + ", RA Dec: " + Utl.HoursToHMS(Ra, ":", ":", "", 3) + " " + Utl.DegreesToDMS(Dec, ":", ":", "", 3));
               return rc;
            }
            else {
               rc = TopoStar32(JdTt, DeltaT, ref Star, ref Position, Accuracy, ref Ra, ref Dec);
               TL.LogMessage("TopoStar", "  32bit - Return Code: " + System.Convert.ToString(rc) + ", RA Dec: " + Utl.HoursToHMS(Ra, ":", ":", "", 3) + " " + Utl.DegreesToDMS(Dec, ":", ":", "", 3));
               return rc;
            }
         }
         catch (Exception ex) {
      ...
      /// </para>
      /// </remarks>
      public void TransformHip(CatEntry3 Hipparcos, ref
         CatEntry3 Hip2000)
      {
         if (Is64Bit()) {
      ...
      {
         if (Is64Bit()) {
            PosVector temp_Pos = ArrToPosVec(Pos);
            return Vector2RaDec64(ref temp_Pos, ref Ra, ref Dec);
         }
         else {
            PosVector temp_Pos2 = ArrToPosVec(Pos);
            return Vector2RaDec32(ref temp_Pos2, ref Ra, ref Dec);
         }
      }
      ...
      public short VirtualPlanet(double JdTt, Object3 SsBody, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis)
      {
         if (Is64Bit()) {
            Object3Internal temp_SsBody = O3IFromObject3(SsBody);
            return VirtualPlanet64(JdTt, ref temp_SsBody, Accuracy, ref Ra, ref Dec, ref Dis);
         }
         else {
            Object3Internal temp_SsBody2 = O3IFromObject3(SsBody);
            return VirtualPlanet32(JdTt, ref temp_SsBody2, Accuracy, ref Ra, ref Dec, ref Dis);
         }
      }
      ...
      public void Wobble(double Tjd, TransformationDirection Direction, double xp, double yp, double[] Pos1, ref double[] Pos2)
      {
         ...
         if (Is64Bit()) {
            PosVector temp_Pos1 = ArrToPosVec(Pos1);
            Wobble64(Tjd, System.Convert.ToInt16(Direction), xp, yp, ref temp_Pos1, ref VPos2);
         }
         else {
            PosVector temp_Pos12 = ArrToPosVec(Pos1);
            Wobble32(Tjd, System.Convert.ToInt16(Direction), xp, yp, ref temp_Pos12, ref VPos2);
         }
      ...
      [DllImport(NOVAS32DLL, EntryPoint = "set_racio_file")] private static extern void SetRACIOFile32(string FName);

      [DllImportAttribute(NOVAS32DLL, EntryPoint = "ephem_close")]
      private static short EphemClose32()
      {
      }

      [DllImportAttribute(NOVAS32DLL, EntryPoint = "ephem_open")]
      private static short EphemOpen32(string Ephem_Name, double JD_Begin, double JD_End, short DENumber)
      {
      }

      [DllImport(NOVAS32DLL, EntryPoint = "planet_ephemeris")]
      private static extern short PlanetEphemeris32(ref JDHighPrecision Tjd,
      Target Target,
      Target Center, ref
      PosVector Position, ref
      VelVector Velocity);

      [DllImport(NOVAS32DLL, EntryPoint = "readeph")] private static extern System.IntPtr ReadEph32(int Mp, string Name, double Jd, ref int Err);

      [DllImport(NOVAS32DLL, EntryPoint = "cleaneph")] private static extern void CleanEph32();

      [DllImport(NOVAS32DLL, EntryPoint = "solarsystem")] private static extern short SolarSystem32(double tjd, short body, short origin, ref PosVector pos, ref VelVector vel);

      [DllImport(NOVAS32DLL, EntryPoint = "state")]
      private static extern short State32(ref JDHighPrecision Jed,
      Target Target, ref
      PosVector TargetPos, ref
      VelVector TargetVel);
      #endregion

      #region DLL Entry Points NOVAS (32bit)
      [DllImport(NOVAS32DLL, EntryPoint = "aberration")]
      private static extern void Aberration32(ref PosVector Pos, ref
      VelVector Vel,
      double LightTime, ref
      PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "app_planet")] private static extern short AppPlanet32(double JdTt, ref Object3Internal SsBody, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS32DLL, EntryPoint = "app_star")] private static extern short AppStar32(double JdTt, ref CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS32DLL, EntryPoint = "astro_planet")] private static extern short AstroPlanet32(double JdTt, ref Object3Internal SsBody, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS32DLL, EntryPoint = "astro_star")] private static extern short AstroStar32(double JdTt, ref CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS32DLL, EntryPoint = "bary2obs")] private static extern void Bary2Obs32(ref PosVector Pos, ref PosVector PosObs, ref PosVector Pos2, ref double Lighttime);

      [DllImport(NOVAS32DLL, EntryPoint = "cal_date")] private static extern void CalDate32(double Tjd, ref short Year, ref short Month, ref short Day, ref double Hour);

      [DllImport(NOVAS32DLL, EntryPoint = "cel2ter")] private static extern short Cel2Ter32(double JdHigh, double JdLow, double DeltaT, Method Method, Accuracy Accuracy, OutputVectorOption OutputOption, double x, double y, ref PosVector VecT, ref PosVector VecC);

      [DllImport(NOVAS32DLL, EntryPoint = "cel_pole")] private static extern short CelPole32(double Tjd, PoleOffsetCorrection Type, double Dpole1, double Dpole2);

      [DllImport(NOVAS32DLL, EntryPoint = "cio_array")]
      private static extern short CioArray32(double JdTdb,
      int NPts, ref
      RAOfCioArray Cio);

      [DllImport(NOVAS32DLL, EntryPoint = "cio_basis")] private static extern short CioBasis32(double JdTdbEquionx, double RaCioEquionx, ReferenceSystem RefSys, Accuracy Accuracy, ref double x, ref double y, ref double z);

      [DllImport(NOVAS32DLL, EntryPoint = "cio_location")] private static extern short CioLocation32(double JdTdb, Accuracy Accuracy, ref double RaCio, ref ReferenceSystem RefSys);

      [DllImport(NOVAS32DLL, EntryPoint = "cio_ra")] private static extern short CioRa32(double JdTt, Accuracy Accuracy, ref double RaCio);

      [DllImport(NOVAS32DLL, EntryPoint = "d_light")]
      private static extern double DLight32(ref PosVector Pos1, ref
      PosVector PosObs);

      [DllImport(NOVAS32DLL, EntryPoint = "e_tilt")] private static extern void ETilt32(double JdTdb, Accuracy Accuracy, ref double Mobl, ref double Tobl, ref double Ee, ref double Dpsi, ref double Deps);

      [DllImport(NOVAS32DLL, EntryPoint = "ecl2equ_vec")]
      private static extern short Ecl2EquVec32(double JdTt,
      CoordSys CoordSys,
      Accuracy Accuracy, ref PosVector
      Pos1, ref
      PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "ee_ct")] private static extern double EeCt32(double JdHigh, double JdLow, Accuracy Accuracy);

      [DllImport(NOVAS32DLL, EntryPoint = "ephemeris")]
      private static extern short Ephemeris32(ref JDHighPrecision Jd, ref
      Object3Internal CelObj,
      Origin Origin,
      Accuracy Accuracy, ref
      PosVector Pos, ref
      VelVector Vel);

      [DllImport(NOVAS32DLL, EntryPoint = "equ2ecl")] private static extern short Equ2Ecl32(double JdTt, CoordSys CoordSys, Accuracy Accuracy, double Ra, double Dec, ref double ELon, ref double ELat);

      [DllImport(NOVAS32DLL, EntryPoint = "equ2ecl_vec")]
      private static extern short Equ2EclVec32(double JdTt,
      CoordSys CoordSys,
      Accuracy Accuracy, ref PosVector
      Pos1, ref
      PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "equ2gal")] private static extern void Equ2Gal32(double RaI, double DecI, ref double GLon, ref double GLat);

      [DllImport(NOVAS32DLL, EntryPoint = "equ2hor")] private static extern void Equ2Hor32(double Jd_Ut1, double DeltT, Accuracy Accuracy, double x, double y, ref OnSurface Location, double Ra, double Dec, RefractionOption RefOption, ref double Zd, ref double Az, ref double RaR, ref double DecR);

      [DllImport(NOVAS32DLL, EntryPoint = "era")]
      private static extern double Era32(double JdHigh,
      double JdLow);

      [DllImport(NOVAS32DLL, EntryPoint = "frame_tie")] private static extern void FrameTie32(ref PosVector Pos1, FrameConversionDirection Direction, ref PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "fund_args")]
      private static extern void FundArgs32(double t, ref
      FundamentalArgs a);

      [DllImport(NOVAS32DLL, EntryPoint = "gcrs2equ")] private static extern short Gcrs2Equ32(double JdTt, CoordSys CoordSys, Accuracy Accuracy, double RaG, double DecG, ref double Ra, ref double Dec);

      [DllImport(NOVAS32DLL, EntryPoint = "geo_posvel")] private static extern short GeoPosVel32(double JdTt, double DeltaT, Accuracy Accuracy, ref Observer Obs, ref PosVector Pos, ref VelVector Vel);

      [DllImport(NOVAS32DLL, EntryPoint = "grav_def")] private static extern short GravDef32(double JdTdb, EarthDeflection LocCode, Accuracy Accuracy, ref PosVector Pos1, ref PosVector PosObs, ref PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "grav_vec")] private static extern void GravVec32(ref PosVector Pos1, ref PosVector PosObs, ref PosVector PosBody, double RMass, ref PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "ira_equinox")]
      private static extern double IraEquinox32(double JdTdb,
      EquinoxType Equinox,
      Accuracy Accuracy);

      [DllImport(NOVAS32DLL, EntryPoint = "julian_date")] private static extern double JulianDate32(short Year, short Month, short Day, double Hour);

      [DllImport(NOVAS32DLL, EntryPoint = "light_time")] private static extern short LightTime32(double JdTdb, ref Object3Internal SsObject, ref PosVector PosObs, double TLight0, Accuracy Accuracy, ref PosVector Pos, ref double TLight);

      [DllImport(NOVAS32DLL, EntryPoint = "limb_angle")] private static extern void LimbAngle32(ref PosVector PosObj, ref PosVector PosObs, ref double LimbAng, ref double NadirAng);

      [DllImport(NOVAS32DLL, EntryPoint = "local_planet")] private static extern short LocalPlanet32(double JdTt, ref Object3Internal SsBody, double DeltaT, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS32DLL, EntryPoint = "local_star")] private static extern short LocalStar32(double JdTt, double DeltaT, ref CatEntry3 Star, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS32DLL, EntryPoint = "make_cat_entry")] private static extern void MakeCatEntry32(string StarName, string Catalog, int StarNum, double Ra, double Dec, double PmRa, double PmDec, double Parallax, double RadVel, ref CatEntry3 Star);

      [DllImport(NOVAS32DLL, EntryPoint = "make_in_space")]
      private static extern void MakeInSpace32(ref PosVector ScPos, ref
      VelVector ScVel, ref
      InSpace ObsSpace);

      [DllImport(NOVAS32DLL, EntryPoint = "make_object")] private static extern short MakeObject32(ObjectType Type, short Number, string Name, ref CatEntry3 StarData, ref Object3Internal CelObj);

      [DllImport(NOVAS32DLL, EntryPoint = "make_observer")]
      private static extern short MakeObserver32(ObserverLocation Where, ref
      OnSurface ObsSurface, ref
      InSpace ObsSpace, ref
      Observer Obs);

      [DllImport(NOVAS32DLL, EntryPoint = "make_observer_at_geocenter")] private static extern void MakeObserverAtGeocenter32(ref Observer ObsAtGeocenter);

      [DllImport(NOVAS32DLL, EntryPoint = "make_observer_in_space")]
      private static extern void MakeObserverInSpace32(ref PosVector ScPos, ref
      VelVector ScVel, ref
      Observer ObsInSpace);

      [DllImport(NOVAS32DLL, EntryPoint = "make_observer_on_surface")] private static extern void MakeObserverOnSurface32(double Latitude, double Longitude, double Height, double Temperature, double Pressure, ref Observer ObsOnSurface);

      [DllImport(NOVAS32DLL, EntryPoint = "make_on_surface")] private static extern void MakeOnSurface32(double Latitude, double Longitude, double Height, double Temperature, double Pressure, ref OnSurface ObsSurface);

      [DllImport(NOVAS32DLL, EntryPoint = "mean_obliq")] private static extern double MeanObliq32(double JdTdb);

      [DllImport(NOVAS32DLL, EntryPoint = "mean_star")] private static extern short MeanStar32(double JdTt, double Ra, double Dec, Accuracy Accuracy, ref double IRa, ref double IDec);

      [DllImport(NOVAS32DLL, EntryPoint = "norm_ang")] private static extern double NormAng32(double Angle);

      [DllImport(NOVAS32DLL, EntryPoint = "nutation")]
      private static extern void Nutation32(double JdTdb,
      NutationDirection Direction,
      Accuracy Accuracy, ref
      PosVector Pos, ref
      PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "nutation_angles")] private static extern void NutationAngles32(double t, Accuracy Accuracy, ref double DPsi, ref double DEps);

      [DllImport(NOVAS32DLL, EntryPoint = "place")] private static extern short Place32(double JdTt, ref Object3Internal CelObject, ref Observer Location, double DeltaT, CoordSys CoordSys, Accuracy Accuracy, ref SkyPos Output);

      [DllImport(NOVAS32DLL, EntryPoint = "precession")] private static extern short Precession32(double JdTdb1, ref PosVector Pos1, double JdTdb2, ref PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "proper_motion")] private static extern void ProperMotion32(double JdTdb1, ref PosVector Pos, ref VelVector Vel, double JdTdb2, ref PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "rad_vel")] private static extern void RadVel32(ref Object3Internal CelObject, ref PosVector Pos, ref VelVector Vel, ref VelVector VelObs, double DObsGeo, double DObsSun, double DObjSun, ref double Rv);

      [DllImport(NOVAS32DLL, EntryPoint = "radec2vector")] private static extern void RaDec2Vector32(double Ra, double Dec, double Dist, ref PosVector Vector);

      [DllImport(NOVAS32DLL, EntryPoint = "refract")]
      private static extern double Refract32(ref OnSurface Location,
      RefractionOption RefOption,
      double ZdObs);

      [DllImport(NOVAS32DLL, EntryPoint = "sidereal_time")] private static extern short SiderealTime32(double JdHigh, double JdLow, double DeltaT, GstType GstType, Method Method, Accuracy Accuracy, ref double Gst);

      [DllImport(NOVAS32DLL, EntryPoint = "spin")]
      private static extern void Spin32(double Angle, ref PosVector
      Pos1, ref
      PosVector Pos2);

      [DllImport(NOVAS32DLL, EntryPoint = "starvectors")]
      private static extern void StarVectors32(ref CatEntry3 Star, ref
      PosVector Pos, ref
      VelVector Vel);

      [DllImport(NOVAS32DLL, EntryPoint = "tdb2tt")] private static extern void Tdb2Tt32(double TdbJd, ref double TtJd, ref double SecDiff);

      [DllImport(NOVAS32DLL, EntryPoint = "ter2cel")] private static extern short Ter2Cel32(double JdHigh, double JdLow, double DeltaT, Method Method, Accuracy Accuracy, OutputVectorOption OutputOption, double x, double y, ref PosVector VecT, ref PosVector VecC);

      [DllImport(NOVAS32DLL, EntryPoint = "terra")]
      private static extern void Terra32(ref OnSurface Location,
      double St, ref
      PosVector Pos, ref
      VelVector Vel);

      [DllImport(NOVAS32DLL, EntryPoint = "topo_planet")] private static extern short TopoPlanet32(double JdTt, ref Object3Internal SsBody, double DeltaT, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS32DLL, EntryPoint = "topo_star")] private static extern short TopoStar32(double JdTt, double DeltaT, ref CatEntry3 Star, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS32DLL, EntryPoint = "transform_cat")] private static extern short TransformCat32(TransformationOption3 TransformOption, double DateInCat, ref CatEntry3 InCat, double DateNewCat, string NewCatId, ref CatEntry3 NewCat);


      [DllImport(NOVAS32DLL, EntryPoint = "transform_hip")]
      private static extern void TransformHip32(ref CatEntry3 Hipparcos, ref
      CatEntry3 Hip2000);

      [DllImport(NOVAS32DLL, EntryPoint = "vector2radec")]
      private static extern short Vector2RaDec32(ref PosVector Pos, ref double
      Ra, ref
      double Dec);

      [DllImport(NOVAS32DLL, EntryPoint = "virtual_planet")] private static extern short VirtualPlanet32(double JdTt, ref Object3Internal SsBody, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS32DLL, EntryPoint = "virtual_star")] private static extern short VirtualStar32(double JdTt, ref CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS32DLL, EntryPoint = "wobble")] private static extern void Wobble32(double Tjd, short Direction, double x, double y, ref PosVector Pos1, ref PosVector Pos2);
      #endregion

      #region DLL Entry Points for Ephemeris and RACIOFile (64bit)
      [DllImport(NOVAS64DLL, EntryPoint = "set_racio_file")] private static extern void SetRACIOFile64(string Name);

      [DllImportAttribute(NOVAS64DLL, EntryPoint = "ephem_close")]
      private static short EphemClose64()
      {
      }

      [DllImportAttribute(NOVAS64DLL, EntryPoint = "ephem_open")]
      private static short EphemOpen64(string Ephem_Name, double JD_Begin, double JD_End, short DENumber)
      {
      }

      [DllImport(NOVAS64DLL, EntryPoint = "planet_ephemeris")]
      private static extern short PlanetEphemeris64(ref JDHighPrecision Tjd,
      Target Target,
      Target Center, ref
      PosVector Position, ref
      VelVector Velocity);

      [DllImport(NOVAS64DLL, EntryPoint = "readeph")] private static extern System.IntPtr ReadEph64(int Mp, string Name, double Jd, ref int Err);

      [DllImport(NOVAS64DLL, EntryPoint = "cleaneph")] private static extern void CleanEph64();

      [DllImport(NOVAS64DLL, EntryPoint = "solarsystem")] private static extern short SolarSystem64(double tjd, short body, short origin, ref PosVector pos, ref VelVector vel);

      [DllImport(NOVAS64DLL, EntryPoint = "state")]
      private static extern short State64(ref JDHighPrecision Jed,
      Target Target, ref
      PosVector TargetPos, ref
      VelVector TargetVel);
      #endregion
      ...
      private static extern void Aberration64(ref PosVector Pos, ref
      VelVector Vel,
      double LightTime, ref
      PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "app_planet")] private static extern short AppPlanet64(double JdTt, ref Object3Internal SsBody, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS64DLL, EntryPoint = "app_star")] private static extern short AppStar64(double JdTt, ref CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS64DLL, EntryPoint = "astro_planet")] private static extern short AstroPlanet64(double JdTt, ref Object3Internal SsBody, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS64DLL, EntryPoint = "astro_star")] private static extern short AstroStar64(double JdTt, ref CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS64DLL, EntryPoint = "bary2obs")] private static extern void Bary2Obs64(ref PosVector Pos, ref PosVector PosObs, ref PosVector Pos2, ref double Lighttime);

      [DllImport(NOVAS64DLL, EntryPoint = "cal_date")] private static extern void CalDate64(double Tjd, ref short Year, ref short Month, ref short Day, ref double Hour);

      [DllImport(NOVAS64DLL, EntryPoint = "cel2ter")] private static extern short Cel2Ter64(double JdHigh, double JdLow, double DeltaT, Method Method, Accuracy Accuracy, OutputVectorOption OutputOption, double x, double y, ref PosVector VecT, ref PosVector VecC);

      [DllImport(NOVAS64DLL, EntryPoint = "cel_pole")] private static extern short CelPole64(double Tjd, PoleOffsetCorrection Type, double Dpole1, double Dpole2);

      [DllImport(NOVAS64DLL, EntryPoint = "cio_array")]
      private static extern short CioArray64(double JdTdb,
      int NPts, ref
      RAOfCioArray Cio);

      [DllImport(NOVAS64DLL, EntryPoint = "cio_basis")] private static extern short CioBasis64(double JdTdbEquionx, double RaCioEquionx, ReferenceSystem RefSys, Accuracy Accuracy, ref double x, ref double y, ref double z);

      [DllImport(NOVAS64DLL, EntryPoint = "cio_location")] private static extern short CioLocation64(double JdTdb, Accuracy Accuracy, ref double RaCio, ref ReferenceSystem RefSys);

      [DllImport(NOVAS64DLL, EntryPoint = "cio_ra")] private static extern short CioRa64(double JdTt, Accuracy Accuracy, ref double RaCio);

      [DllImport(NOVAS64DLL, EntryPoint = "d_light")]
      private static extern double DLight64(ref PosVector Pos1, ref
      PosVector PosObs);

      [DllImport(NOVAS64DLL, EntryPoint = "e_tilt")] private static extern void ETilt64(double JdTdb, Accuracy Accuracy, ref double Mobl, ref double Tobl, ref double Ee, ref double Dpsi, ref double Deps);

      [DllImport(NOVAS64DLL, EntryPoint = "ecl2equ_vec")]
      private static extern short Ecl2EquVec64(double JdTt,
      CoordSys CoordSys,
      Accuracy Accuracy, ref PosVector
      Pos1, ref
      PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "ee_ct")] private static extern double EeCt64(double JdHigh, double JdLow, Accuracy Accuracy);

      [DllImport(NOVAS64DLL, EntryPoint = "ephemeris")]
      private static extern short Ephemeris64(ref JDHighPrecision Jd, ref
      Object3Internal CelObj,
      Origin Origin,
      Accuracy Accuracy, ref
      PosVector Pos, ref
      ...
      [DllImport(NOVAS64DLL, EntryPoint = "equ2ecl")] private static extern short Equ2Ecl64(double JdTt, CoordSys CoordSys, Accuracy Accuracy, double Ra, double Dec, ref double ELon, ref double ELat);

      [DllImport(NOVAS64DLL, EntryPoint = "equ2ecl_vec")]
      private static extern short Equ2EclVec64(double JdTt,
      CoordSys CoordSys,
      Accuracy Accuracy, ref PosVector
      Pos1, ref
      PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "equ2gal")] private static extern void Equ2Gal64(double RaI, double DecI, ref double GLon, ref double GLat);

      [DllImport(NOVAS64DLL, EntryPoint = "equ2hor")] private static extern void Equ2Hor64(double Jd_Ut1, double DeltT, Accuracy Accuracy, double x, double y, ref OnSurface Location, double Ra, double Dec, RefractionOption RefOption, ref double Zd, ref double Az, ref double RaR, ref double DecR);

      [DllImport(NOVAS64DLL, EntryPoint = "era")]
      private static extern double Era64(double JdHigh,
      double JdLow);

      [DllImport(NOVAS64DLL, EntryPoint = "frame_tie")] private static extern void FrameTie64(ref PosVector Pos1, FrameConversionDirection Direction, ref PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "fund_args")]
      private static extern void FundArgs64(double t, ref
      FundamentalArgs a);

      [DllImport(NOVAS64DLL, EntryPoint = "gcrs2equ")] private static extern short Gcrs2Equ64(double JdTt, CoordSys CoordSys, Accuracy Accuracy, double RaG, double DecG, ref double Ra, ref double Dec);

      [DllImport(NOVAS64DLL, EntryPoint = "geo_posvel")] private static extern short GeoPosVel64(double JdTt, double DeltaT, Accuracy Accuracy, ref Observer Obs, ref PosVector Pos, ref VelVector Vel);

      [DllImport(NOVAS64DLL, EntryPoint = "grav_def")] private static extern short GravDef64(double JdTdb, EarthDeflection LocCode, Accuracy Accuracy, ref PosVector Pos1, ref PosVector PosObs, ref PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "grav_vec")] private static extern void GravVec64(ref PosVector Pos1, ref PosVector PosObs, ref PosVector PosBody, double RMass, ref PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "ira_equinox")]
      private static extern double IraEquinox64(double JdTdb,
      EquinoxType Equinox,
      Accuracy Accuracy);

      [DllImport(NOVAS64DLL, EntryPoint = "julian_date")] private static extern double JulianDate64(short Year, short Month, short Day, double Hour);

      [DllImport(NOVAS64DLL, EntryPoint = "light_time")] private static extern short LightTime64(double JdTdb, ref Object3Internal SsObject, ref PosVector PosObs, double TLight0, Accuracy Accuracy, ref PosVector Pos, ref double TLight);

      [DllImport(NOVAS64DLL, EntryPoint = "limb_angle")] private static extern void LimbAngle64(ref PosVector PosObj, ref PosVector PosObs, ref double LimbAng, ref double NadirAng);

      [DllImport(NOVAS64DLL, EntryPoint = "local_planet")] private static extern short LocalPlanet64(double JdTt, ref Object3Internal SsBody, double DeltaT, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS64DLL, EntryPoint = "local_star")] private static extern short LocalStar64(double JdTt, double DeltaT, ref CatEntry3 Star, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS64DLL, EntryPoint = "make_cat_entry")] private static extern void MakeCatEntry64(string StarName, string Catalog, int StarNum, double Ra, double Dec, double PmRa, double PmDec, double Parallax, double RadVel, ref CatEntry3 Star);

      [DllImport(NOVAS64DLL, EntryPoint = "make_in_space")]
      private static extern void MakeInSpace64(ref PosVector ScPos, ref
      VelVector ScVel, ref
      InSpace ObsSpace);

      [DllImport(NOVAS64DLL, EntryPoint = "make_object")] private static extern short MakeObject64(ObjectType Type, short Number, string Name, ref CatEntry3 StarData, ref Object3Internal CelObj);

      [DllImport(NOVAS64DLL, EntryPoint = "make_observer")]
      private static extern short MakeObserver64(ObserverLocation Where, ref
      OnSurface ObsSurface, ref
      InSpace ObsSpace, ref
      Observer Obs);

      [DllImport(NOVAS64DLL, EntryPoint = "make_observer_at_geocenter")] private static extern void MakeObserverAtGeocenter64(ref Observer ObsAtGeocenter);

      [DllImport(NOVAS64DLL, EntryPoint = "make_observer_in_space")]
      private static extern void MakeObserverInSpace64(ref PosVector ScPos, ref
      VelVector ScVel, ref
      Observer ObsInSpace);

      [DllImport(NOVAS64DLL, EntryPoint = "make_observer_on_surface")] private static extern void MakeObserverOnSurface64(double Latitude, double Longitude, double Height, double Temperature, double Pressure, ref Observer ObsOnSurface);

      [DllImport(NOVAS64DLL, EntryPoint = "make_on_surface")] private static extern void MakeOnSurface64(double Latitude, double Longitude, double Height, double Temperature, double Pressure, ref OnSurface ObsSurface);

      [DllImport(NOVAS64DLL, EntryPoint = "mean_obliq")] private static extern double MeanObliq64(double JdTdb);

      [DllImport(NOVAS64DLL, EntryPoint = "mean_star")] private static extern short MeanStar64(double JdTt, double Ra, double Dec, Accuracy Accuracy, ref double IRa, ref double IDec);

      [DllImport(NOVAS64DLL, EntryPoint = "norm_ang")] private static extern double NormAng64(double Angle);

      [DllImport(NOVAS64DLL, EntryPoint = "nutation")]
      private static extern void Nutation64(double JdTdb,
      NutationDirection Direction,
      Accuracy Accuracy, ref
      PosVector Pos, ref
      PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "nutation_angles")] private static extern void NutationAngles64(double t, Accuracy Accuracy, ref double DPsi, ref double DEps);

      [DllImport(NOVAS64DLL, EntryPoint = "place")] private static extern short Place64(double JdTt, ref Object3Internal CelObject, ref Observer Location, double DeltaT, CoordSys CoordSys, Accuracy Accuracy, ref SkyPos Output);

      [DllImport(NOVAS64DLL, EntryPoint = "precession")] private static extern short Precession64(double JdTdb1, ref PosVector Pos1, double JdTdb2, ref PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "proper_motion")] private static extern void ProperMotion64(double JdTdb1, ref PosVector Pos, ref VelVector Vel, double JdTdb2, ref PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "rad_vel")] private static extern void RadVel64(ref Object3Internal CelObject, ref PosVector Pos, ref VelVector Vel, ref VelVector VelObs, double DObsGeo, double DObsSun, double DObjSun, ref double Rv);

      [DllImport(NOVAS64DLL, EntryPoint = "radec2vector")] private static extern void RaDec2Vector64(double Ra, double Dec, double Dist, ref PosVector Vector);

      [DllImport(NOVAS64DLL, EntryPoint = "refract")]
      private static extern double Refract64(ref OnSurface Location,
      RefractionOption RefOption,
      double ZdObs);

      [DllImport(NOVAS64DLL, EntryPoint = "sidereal_time")] private static extern short SiderealTime64(double JdHigh, double JdLow, double DeltaT, GstType GstType, Method Method, Accuracy Accuracy, ref double Gst);

      [DllImport(NOVAS64DLL, EntryPoint = "spin")]
      private static extern void Spin64(double Angle, ref PosVector
      Pos1, ref
      PosVector Pos2);

      [DllImport(NOVAS64DLL, EntryPoint = "starvectors")]
      private static extern void StarVectors64(ref CatEntry3 Star, ref
      PosVector Pos, ref
      VelVector Vel);

      [DllImport(NOVAS64DLL, EntryPoint = "tdb2tt")] private static extern void Tdb2Tt64(double TdbJd, ref double TtJd, ref double SecDiff);

      [DllImport(NOVAS64DLL, EntryPoint = "ter2cel")] private static extern short Ter2Cel64(double JdHigh, double JdLow, double DeltaT, Method Method, Accuracy Accuracy, OutputVectorOption OutputOption, double x, double y, ref PosVector VecT, ref PosVector VecC);

      [DllImport(NOVAS64DLL, EntryPoint = "terra")]
      private static extern void Terra64(ref OnSurface Location,
      double St, ref
      PosVector Pos, ref
      VelVector Vel);

      [DllImport(NOVAS64DLL, EntryPoint = "topo_planet")] private static extern short TopoPlanet64(double JdTt, ref Object3Internal SsBody, double DeltaT, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS64DLL, EntryPoint = "topo_star")] private static extern short TopoStar64(double JdTt, double DeltaT, ref CatEntry3 Star, ref OnSurface Position, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS64DLL, EntryPoint = "transform_cat")] private static extern short TransformCat64(TransformationOption3 TransformOption, double DateInCat, ref CatEntry3 InCat, double DateNewCat, string NewCatId, ref CatEntry3 NewCat);


      [DllImport(NOVAS64DLL, EntryPoint = "transform_hip")]
      private static extern void TransformHip64(ref CatEntry3 Hipparcos, ref
      CatEntry3 Hip2000);

      [DllImport(NOVAS64DLL, EntryPoint = "vector2radec")]
      private static extern short Vector2RaDec64(ref PosVector Pos, ref double
      Ra, ref
      double Dec);

      [DllImport(NOVAS64DLL, EntryPoint = "virtual_planet")] private static extern short VirtualPlanet64(double JdTt, ref Object3Internal SsBody, Accuracy Accuracy, ref double Ra, ref double Dec, ref double Dis);

      [DllImport(NOVAS64DLL, EntryPoint = "virtual_star")] private static extern short VirtualStar64(double JdTt, ref CatEntry3 Star, Accuracy Accuracy, ref double Ra, ref double Dec);

      [DllImport(NOVAS64DLL, EntryPoint = "wobble")] private static extern void Wobble64(double Tjd, short Direction, double x, double y, ref PosVector Pos1, ref PosVector Pos2);
      #endregion
      ...
      /// <remarks></remarks>
      [DllImport("shell32.dll")] static public extern bool SHGetSpecialFolderPath(IntPtr hwndOwner, System.Text.StringBuilder lpszPath, int nFolder, bool fCreate);
      ...
      private static void PosVecToArr(PosVector V, ref double[] Ar)
      {
         ...
         Ar[0] = System.Convert.ToDouble(V.x);
         Ar[1] = System.Convert.ToDouble(V.y);
         Ar[2] = System.Convert.ToDouble(V.z);
      }

      private static VelVector ArrToVelVec(double[] Arr)
      {
         //Create a new vector having the values in the supplied double array
         VelVector V = new VelVector();
         V.x = Arr[0];
         V.y = Arr[1];
         V.z = Arr[2];
         return V;
      ...
      private static void RACioArrayStructureToArr(RAOfCioArray C, ArrayList Ar)
      {
         //Transfer all RACio values that have actually been set by the NOVAS DLL to the arraylist for return to the client
         if (C.Value1.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value1);
         }
         if (C.Value2.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value2);
         }
         if (C.Value3.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value3);
         }
         if (C.Value4.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value4);
         }
         if (C.Value5.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value5);
         }
         if (C.Value6.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value6);
         }
         if (C.Value7.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value7);
         }
         if (C.Value8.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value8);
         }
         if (C.Value9.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value9);
         }
         if (C.Value10.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value10);
         }
         if (C.Value11.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value11);
         }
         if (C.Value12.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value12);
         }
         if (C.Value13.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value13);
         }
         if (C.Value14.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value14);
         }
         if (C.Value15.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value15);
         }
         if (C.Value16.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value16);
         }
         if (C.Value17.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value17);
         }
         if (C.Value18.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value18);
         }
         if (C.Value19.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value19);
         }
         if (C.Value20.RACio != RACIO_DEFAULT_VALUE) {
            Ar.Add(C.Value20);
         }
      }

      private void O3FromO3Internal(Object3Internal O3I, Object3 O3)
      {
         O3.Name = O3I.Name;
      ...
      private Object3Internal O3IFromObject3(Object3 O3)
      {
         Object3Internal O3I = new Object3Internal();
         O3I.Name = O3.Name;
         O3I.Number = System.Convert.ToInt16(O3.Number);
         O3I.Star = O3.Star;
         O3I.Type = O3.Type;
         return O3I;
      }
