namespace ASCOM.Astrometry
{
   sealed class Mlr404Data
   {
      ...
      internal static double[] tabl = new double[] {175667, 66453, 5249, -42,
      20057, 403, -2360, 6148,
      ...
      internal static double[] tabr = new double[] {-5422, -2120, 1077, 772,
      39, 75, 3, 10,
      -468, -326, -113, -78,
      -4, -2,
      1, 3,
      ...
      internal static plantbl moonlr = new plantbl(
         14,
         new int[NARGS + 1] { 3, 26, 29, 23, 5, 10, 0, 0, 0, 8, 4, 4, 6, 2, 0, 0, 0, 0, 0 },
         3,
         args,
         tabl,
         tabb,
