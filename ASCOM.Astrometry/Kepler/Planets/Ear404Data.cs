using static ASCOM.Astrometry.Kepler.KeplerGlobalCode;
namespace ASCOM.Astrometry
{
   sealed class Ear404Data
   {
      ...
      internal static double[] tabl = new double[] {-242809, -178223, -6154, -6547,
      ...
      internal static double[] tabb = new double[] {-428091, -488399, 746850, 6,
      210, -93, 32, 1,
      -365, 332, -105, 76,
      -7, 2,
      -8, 14, -1, 2,
      ...
      internal static double[] tabr = new double[] {14575, -26192, -144864, 2,
      -22, 15, -8, -21,
      -148, -104, -14, -75,
      15, 2,
      -5, -3, -1, 0,
      ...
      internal static plantbl ear404 = new plantbl(
         12,
         new int[NARGS + 1] { 2, 11, 14, 19, 6, 10, 2, 2, 0, 1, 1, 4, 0, 0, 0, 0, 0, 0, 0 },
         3,
         args,
         tabl,
         tabb,
