...
sealed class Mlat404Data
{
   ...
   internal static double[] tabl = new double[] {-3, -4,
      4, -1856, 0, 8043,
      -9, -1082,
      -1, -310,
      -1, -522,
   ...
   internal static int[] args = new int[] {0, 1,
      3, 1, 10, 1, 12, -1, 11, 1,
   ...
   internal static plantbl moonlat = new plantbl(
      14,
      new int[NARGS + 1] { 0, 26, 29, 8, 3, 5, 0, 0, 0, 6, 5, 3, 5, 1, 0, 0, 0, 0, 0 },
      3,
      args,
      tabl,
      tabb,
